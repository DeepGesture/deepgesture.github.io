...
Deep learning approaches to gesture generation are implemented using various techniques. However, we generalizes the process into the following main stages, illustrated in \autoref{fig:CommonStage}:
