...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{figures/AllStage}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=0.9\linewidth]{figures/DeepGesture}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{figures/CrossLocalAttention}
