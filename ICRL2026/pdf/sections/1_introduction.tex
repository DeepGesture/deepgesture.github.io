...
%\textbf{Input}
%\begin{itemize}
%	\item {Seed gesture sequence:} $\mathbf{s} \in \mathbb{R}^{N \times D}$
%	\item {Speech signal:} $\mathbf{a}$
%	\item {Text:} $\mathbf{v}$
%	\item {Emotion:} $\mathbf{e}$ (\texttt{Happy}, \texttt{Sad}, \texttt{Neutral}, \texttt{Angry}, \texttt{Old}, \texttt{Funny})
%\end{itemize}
%
%% Predicted Output section
%\textbf{Predicted Output}
%\begin{itemize}
%	\item {Predicted gesture sequence:} $\hat{\mathbf{x}} \in \mathbb{R}^{M \times D}$
%\end{itemize}
%
%% Ground Truth section
%\textbf{Ground Truth}
%\begin{itemize}
%	\item {Ground truth gesture:} $\mathbf{x} \in \mathbb{R}^{M \times D}$
%\end{itemize}
