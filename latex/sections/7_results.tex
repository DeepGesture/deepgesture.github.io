...
Due to the high cost and resource requirements of human evaluations, this work reuses the subjective evaluation results from \textbf{DiffuseStyleGesture}~\cite{yang2023diffusestylegesture} as a baseline. The proposed \textbf{OHGesture} model is not included in the subjective study.
...
\begin{table}[h]
	...
	\resizebox{\linewidth}{!}{%
		\begin{tabular}{lcccccc}
			...
			DiffuseStyleGesture  & 75.04 & 51.40 & 110.18 & 130.83     & 116.03    & 78.53     \\
			ZeroEGG              & 136.33 & 81.22 & 290.47 & 140.24     & 102.44    & 181.07     \\
			\textbf{OHGesture}   & 161.22 & 89.58 & 279.95 & 156.93     & 99.86     & 215.24     \\
			\hline
		\end{tabular}%
	}
...
%
%We also develop the open-source system \hyperlink{https://github.com/hemvip/hemvip.github.io}{hemvip.github.io}\footnote{HEMVIP2: \url{https://github.com/hemvip/hemvip.github.io}} to streamline Prolific-based evaluations. OHGesture model evaluations will be added to the leaderboard via this system.
%
